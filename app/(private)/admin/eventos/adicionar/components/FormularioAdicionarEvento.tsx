...
export default function FormularioAdicionarEvento() {
    ...
    return (
        <main className="flex min-h-screen items-center justify-center   bg-[#d9f5fa] bg-[url('/admin-forminhas-preto-transparente.svg')] bg-cover bg-center bg-no-repeat px-4 py-8">
