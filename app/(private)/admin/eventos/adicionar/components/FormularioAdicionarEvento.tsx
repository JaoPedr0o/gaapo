...
export default function FormularioAdicionarEvento() {
    ...
    return (
        <main className="flex min-h-screen items-center justify-center border-[3px] border-[#202020] bg-[#d9f5fa] bg-[url('/admin-forminhas-preto-transparente.svg')] bg-cover bg-center bg-no-repeat px-4 py-8">
